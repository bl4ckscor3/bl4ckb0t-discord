...
public class SCRules extends AbstractModule {
	...
	static {
		...
		RULES.put("4. Lack of respect", new Rule("Treat others with respect.", "4️⃣"));
		...
		RULES.put("8. Asking about updates", new Rule("Don't ask about updates, particularly release ETAs. They will be published eventually. _It's done when it's done._", "8️⃣"));
